...
export default function TransportOrderMovements() {
  const { data, updateItem, mutation, deleteItem, } = useCollection('transport_order_movement', {
  ...
  const redirectLink = (id) => {
    switch (user?.role) {
      case 'Merchant':
        return `/client/transport/services/order-movements/view-page/${id}`
      case 'Customer':
        return `/customer/transport/services/order-movements/view-page/${id}`
      case 'Root':
        return `/gol/transport/services/order-movements/view-page/${id}`
      default:
        return ''
    }
  }
  ...
  const updateLocation = (id) => {
    switch (user?.role) {
      case 'Merchant':
        return `/client/transport-order-movement/edit/${id}`
      case 'Customer':
        return `/customer/transport-order-movement/edit/${id}`
      case 'Root':
        return `/gol/transport-order-movement/edit/${id}`
      default:
        return ''
    }
  }
  ...
  const trackLocation = (id) => {
    switch (user?.role) {
      case 'Merchant':
        return `/client/transport/services/order-movements/view/${id}`
      case 'Customer':
        return `/customer/transport/services/order-movements/view/${id}`
      case 'Root':
        return `/gol/transport/services/order-movements/view/${id}`
      default:
        return ''
    }
  }
