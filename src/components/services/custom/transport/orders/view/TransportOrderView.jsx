...
export default function CustomTransportOrderView({ orderId }) {
  const { data: orders, isLoading } = useCollection('custom_transport_orders', {
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200 hover:shadow-md transition-all duration-300">
              <div className="text-sm font-medium text-blue-600 mb-1">Start Date</div>
              <div className="text-lg font-bold text-gray-900">
                {new Date(order.startDate).toLocaleDateString('en-US', { day: "2-digit", month: "long", year: "numeric" }) || 'N/A'}
              </div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200 hover:shadow-md transition-all duration-300">
              <div className="text-sm font-medium text-purple-600 mb-1">End Date</div>
              <div className="text-lg font-bold text-gray-900">
                {new Date(order.endDate).toLocaleDateString('en-US', { day: "2-digit", month: "long", year: "numeric" }) || 'N/A'}
              </div>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200 hover:shadow-md transition-all duration-300">
              <div className="text-sm font-medium text-blue-600 mb-1">Start Location</div>
              <div className="text-lg font-bold text-gray-900">{order.startLocation || 'N/A'}</div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200 hover:shadow-md transition-all duration-300">
              <div className="text-sm font-medium text-purple-600 mb-1">End Location</div>
              <div className="text-lg font-bold text-gray-900">{order.endLocation || 'N/A'}</div>
            </div>
          </div>
          {order.vehicleDescription && (
            <div className="mt-6 bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
              <div className="text-sm font-medium text-gray-600 mb-2">Vehicle Description</div>
              <div className="text-gray-900 leading-relaxed">{order.vehicleDescription}</div>
            </div>
          )}
          {order.specialRequest && (
            <div className="mt-6 bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
              <div className="text-sm font-medium text-gray-600 mb-2">Special Request</div>
              <div className="text-gray-900 leading-relaxed">{order.specialRequest}</div>
            </div>
          )}
          {order.orderDescription && (
            <div className="mt-6 bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
              <div className="text-sm font-medium text-gray-600 mb-2">Order Description</div>
              <div className="text-gray-900 leading-relaxed">{order.orderDescription}</div>
            </div>
          )}
        </div>

        {/* Modern provider Information */}
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
          ...
          {order.expand?.provider ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl border border-emerald-200 hover:shadow-md transition-all duration-300">
                ...
                <div className="text-lg font-bold text-gray-900">{order.expand.provider.title}</div>
              </div>
              <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-6 rounded-xl border border-teal-200 hover:shadow-md transition-all duration-300">
                ...
                <div className="text-lg font-bold text-gray-900">{order.expand.provider.location}</div>
              </div>
              <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-6 rounded-xl border border-cyan-200 hover:shadow-md transition-all duration-300">
                ...
                <div className="text-lg font-bold text-gray-900">{order.expand.provider.contact}</div>
              </div>
            </div>
          ) : (
            <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
              <div className="text-gray-400 text-lg">No provider information available</div>
            </div>
          )}
        </div>
