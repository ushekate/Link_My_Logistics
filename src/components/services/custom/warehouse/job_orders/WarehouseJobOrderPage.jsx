...
export default function CustomWarehouseJobOrderPage() {
	const { data, deleteItem } = useCollection('custom_warehouse_job_order', {
		expand: 'order,order.provider,serviceType'
	});
	const { user } = useAuth();
