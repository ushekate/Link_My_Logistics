...
export default function WarehouseOrderInput({ setOrderId }) {
	const { data } = useCollection('custom_warehouse_orders', {
	...
	return (
		<div className="flex flex-col gap-2 relative">
			<Label title="Warehouse Order ID" />
			<Input
				type="text"
				name="orderInfo"
				value={formData.orderInfo}
				onChange={handleChange}
				placeholder="Enter Warehouse Order Id"
				autoComplete="off"
			/>
