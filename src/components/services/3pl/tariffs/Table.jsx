...
import { Eye, Download, Trash, CircleCheckBig, } from 'lucide-react';
...
export default function RequestTable({ service = '' }) {
  const { data, updateItem, mutation, deleteItem, } = useCollection('3pl_tariffs_request', {
