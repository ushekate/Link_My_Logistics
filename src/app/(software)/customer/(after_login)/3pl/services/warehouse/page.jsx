...
import { services_3pl_warehouse } from "@/constants/services";
...
export default function Services3PLPage() {
	...
	const handleSearch = (e) => {
		...
		if (value === '') {
			setFilteredServices(services_3pl_warehouse);
		} else {
			setFilteredServices(services_3pl_warehouse.filter((service) => service.title.toLowerCase().includes(value.toLowerCase())));
		}
