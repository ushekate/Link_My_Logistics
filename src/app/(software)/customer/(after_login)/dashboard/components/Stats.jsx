  ...
  return (
    <div>
      <div className="md:w-full w-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8">
        <div className="bg-accent rounded-lg p-6 grid gap-2 shadow-lg w-full border-2 border-gray-100">
      ...
      <div className="grid md:grid-cols-1 gap-6 py-6 h-fit text-gray-900">
        {/* Bar Chart */}
        <div className="bg-accent rounded-xl p-4 shadow-md border border-primary/30">
