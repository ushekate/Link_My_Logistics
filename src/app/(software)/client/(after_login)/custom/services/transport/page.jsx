...
import { services_3pl_transport } from "@/constants/services";
...
export default function Services3PLPage() {
	...
	const handleSearch = (e) => {
		...
		if (value === '') {
			setFilteredServices(services_3pl_transport);
		} else {
			setFilteredServices(services_3pl_transport.filter((service) => service.title.toLowerCase().includes(value.toLowerCase())));
		}
